...
export default function Teachers({ auth, teachers }: PageProps<TeachersProps>) {
    ...
    const { handleActive, handleDelete } = useTeachers();

    return (
        <AuthenticatedLayout user={auth.user} header="Profesores">
            <Head title="Profesores" />

            <NavigateLink name="teachers.create">Agregar Profesor</NavigateLink>
                    ...
                    {teachers.data.map((teacher) => (
                        ...
                        >
                            <div>
                                ...
                                >
                                    {teacher.name} {teacher.father_last_name}{" "}
                            ...
                            <div className="flex gap-3">
                                ...
                                <button
                                    ...
                                    className="font-bold transition-colors text-center bg-rose-100 text-rose-800 p-2 hover:bg-rose-200"
                                >
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        width="128"
