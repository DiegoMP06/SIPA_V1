        ...
        <>
            ...
            <div className="bg-main bg-no-repeat bg-cover bg-center min-h-screen bg-fixed flex">
                <div className="bg-black-0.6 flex-1 flex flex-col overflow-y-auto">
                    ...
                    <main
                        id="tramites"
                        className="my-16 px-4 mx-auto container"
                    >
                    ...
                    <section className="mb-16 mt-10 px-4 container mx-auto space-y-16">
                        <div className="bg-indigo-950 p-4 rounded-lg border border-indigo-600 max-w-2xl space-y-4 place-self-start mx-auto">
                            ...
                            <p className="font-bold text-white">
                                En nuestro Sistema Institucional de Pagos
                                Académicos, hemos diseñado una plataforma que
                                simplifica y agiliza los procesos financieros
                                relacionados con tu educación. Aquí están
                        ...
                        <ul
                            role="list"
                            className="max-w-5xl grid grid-cols-1 mx-auto gap-6"
                        >
                            ...
                            <li className="bg-indigo-950 border-l-4 border-indigo-600 p-4 space-y-4 rounded max-w-2xl place-self-end">
                                <h3 className="text-indigo-100 font-bold text-xl">
                                    Ficha de Depósito Digital Referenciada
                                    (FDDR):
                                </h3>

                                <div className="space-y-2">
                                    <p className="text-white pl-4">
                                        - Descarga tu FDDR de manera rápida y
                                        sencilla.
                                    </p>

                                    <p className="text-white pl-4">
                                        - Este documento te permite realizar
                                        pagos en cualquier sucursal bancaria
                                        autorizada.
                                    </p>
                                </div>
                            </li>
                            ...
                            <li className="bg-indigo-950 border-l-4 border-indigo-600 p-4 space-y-4 rounded max-w-2xl place-self-end">
                                ...
                                <div className="space-y-2">
                                    <p className="text-white pl-4">
                                        - Recibirás noticias sobre fechas
                                        límite, pagos pendientes y otros eventos
                                        importantes en nuestra página de
                                        Facebook.
                                    </p>

                                    <p className="text-white pl-4">
                                        - No te perderás ningún detalle
                                        relevante para tu proceso académico.
                                    </p>
                                </div>
                            </li>
                            ...
                            <li className="bg-indigo-950 border-l-4 border-indigo-600 p-4 space-y-4 rounded max-w-2xl place-self-start">
                                ...
                                <div className="space-y-2">
                                    <p className="text-white pl-4">
                                        ...
                                        resolver tus dudas y brindarte
                                        asistencia.
                                    </p>
                        ...
                        <p className="bg-indigo-950 p-4 rounded-lg border border-indigo-600 max-w-2xl space-y-4 place-self-start mx-auto font-bold text-white">
                            En resumen, nuestro Sistema Institucional de Pagos
                            Académicos es una herramienta pensada para ti.
                            Simplifica tus trámites financieros y concéntrate en
                            lo más importante: tu formación académica.
                        </p>
                    </section>
                    ...
                    <footer className="bg-indigo-950">
                        <p className="max-w-4xl text-lg lg:text-xl font-bold text-center mx-auto px-4 py-3 text-white">
                            Todos los Derechos Reservado CBTis No. 211{" "}
                            {new Date().getFullYear()}&copy;. Made by Diego
                            Meneses.
                        </p>
                    </footer>
                </div>
